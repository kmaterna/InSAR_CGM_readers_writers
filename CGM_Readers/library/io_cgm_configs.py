...
def read_file_level_config(configfile):
    ...
    # Examples of parsing the configobj:
    # all_sections = configobj.sections();  # [general-config, D071-config, WXYZ-config...]
    # all_tracks = all_sections[1:];   # the tracks alone (not general-config)
    # generalparams_dict = configobj['general-config'];
    # print(generalparams_dict['hdf5_file']);
...
def write_empty_file_level_config(directory):
    ...
    genconfig["production_date"] = "[autogenerated]"
